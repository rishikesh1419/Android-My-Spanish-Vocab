        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(word) || TextUtils.isEmpty(meaning) || TextUtils.isEmpty(usage)) {
                    Toast.makeText(AddWord.this, "Fill all the fields", Toast.LENGTH_SHORT).show();
                }
                else {
                    Pattern pattern = Pattern.compile("\\p{InCombiningDiacriticalMarks}+");
                    norm = pattern.matcher(Normalizer.normalize(word, Normalizer.Form.NFD)).replaceAll("");
                    if (typeBtn == null) {
                        Toast.makeText(AddWord.this, "Select a type", Toast.LENGTH_SHORT).show();
                    } else {
                        if (typeBtn.getText().toString().equals("Noun") && genderBtn == null) {
                            Toast.makeText(AddWord.this, "Select a gender", Toast.LENGTH_SHORT).show();
                        } else {
